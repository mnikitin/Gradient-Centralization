...
parser.add_argument('--gc-type', type=str, default='gc',
                    help='gradient centralization type: gc | gcc')
...
def train(epochs, ctx):
    ...
    if 'gc' in opt.optimizer.lower():
        optimizer_params['gc_type'] = opt.gc_type
